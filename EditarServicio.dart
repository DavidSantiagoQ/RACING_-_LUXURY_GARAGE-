...
class EditarServicioPage extends StatefulWidget {
  ...
  const EditarServicioPage({super.key, required this.servicio});
...
class _EditarServicioPageState extends State<EditarServicioPage> {
  ...
  void initState() {
    ...
    // Cargar info del servicio que se está editando
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              campoTexto("Duración estimada", duracionCtrl, Icons.timer),
              const SizedBox(height: 16),
  ...
  Future<void> guardarCambios() async {
    ...
    final servicioEditado = Servicio(
    ...
    bool exito = await ServicioService()
        .updateServicio(servicioEditado.idServicio!, servicioEditado);
